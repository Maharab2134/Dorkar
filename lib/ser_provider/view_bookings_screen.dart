...
class _ViewBookingsScreenState extends State<ViewBookingsScreen> {
  ...
  Future<List<Bookings>> fetchMyBookings() async {
    String url = 'http://$ip/dorkar/providerfetchbooking.php?pid=$pid';
  ...
  void acceptBooking(String bookingId) async {
    String url = 'http://$ip/dorkar/provideraccepted.php';
  ...
  void rejectBooking(String bookingId) async {
    String url = 'http://$ip/dorkar/providerrejected.php';
  ...
  Color getStatusColor(String status) {
    switch (status) {
      ...
      case 'paid':
        return Colors
            .teal; // Represents a financial transaction successfully made.
      default:
